...
public class AwsDynamoDbLocalTestUtils {
   ...
   *     System.getProperty("java.runtime.name")</code>).
   ...
   *     "java.class.path"</code> system property (<code>System.getProperty("os.arch")</code>) split
   *     by <code>File.pathSeparator</code>.
   * @return
   */
